...
# Import the data 
elephant_data <- read_csv("~/Documents/diffusion_animal_networks/Data/dist.matrix.t1.csv")
...
# Import the data 
elephant_data_w2 <- read_csv("~/Documents/diffusion_animal_networks/Data/dist.matrix.t2.csv")
# Transform data into square matrix
...
# Import the data 
elephant_data_w3 <- read_csv("~/Documents/diffusion_animal_networks/Data/dist.matrix.t3.csv")
# Transform data into square matrix
...
# Import the data
dolphin_edge_lists <- read_csv("~/Documents/diffusion_animal_networks/Data/dolphin_edge_lists.csv")
...
id_list <- read_csv("~/Documents/diffusion_animal_networks/Data/ID_list.csv")
...
write_csv(network_features_df, 
          "~/Documents/diffusion_animal_networks/Data/network_features.csv")