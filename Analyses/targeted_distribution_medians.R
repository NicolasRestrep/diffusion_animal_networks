...
#### Aalysis ####
elephant_w1 <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w1.rds")
elephant_w2 <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w2.rds")
elephant_w3 <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w3.rds")
elephant_w1_bb <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w1_bb.rds")
elephant_w2_bb <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w2_bb.rds")
elephant_w3_bb <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w3_bb.rds")
elephant_w1_cut <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w1_cut.rds")
elephant_w2_cut <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w2_cut.rds")
elephant_w3_cut <- read_rds("~/diffusion_animal_networks/Data/networks/elephant_w3_cut.rds")
dolphin_w1 <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w1.rds")
dolphin_w2 <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w2.rds")
dolphin_w3 <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w3.rds")
dolphin_w4 <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w4.rds")
dolphin_w5 <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w5.rds")
dolphin_w6 <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w6.rds")
dolphin_w1_bb <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w1_bb.rds")
dolphin_w2_bb <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w2_bb.rds")
dolphin_w3_bb <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w3_bb.rds")
dolphin_w4_bb <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w4_bb.rds")
dolphin_w5_bb <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w5_bb.rds")
dolphin_w6_bb <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w6_bb.rds")
dolphin_w1_cut <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w1_cut.rds")
dolphin_w2_cut <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w2_cut.rds")
dolphin_w3_cut <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w3_cut.rds")
dolphin_w4_cut <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w4_cut.rds")
dolphin_w5_cut <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w5_cut.rds")
dolphin_w6_cut <- read_rds("~/diffusion_animal_networks/Data/networks/dolphin_w6_cut.rds")
